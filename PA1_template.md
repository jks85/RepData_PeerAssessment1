...
similarity of the two plots. In a deeper analysis would be worthwhile to examine
whether weekdays or weekends were over-represented in the imputed data. It 
may also be advisable compare weekday vs weekend steps by ignoring the original
missing data.
